...
{
	public class ShimmerBiomeWand : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.ShimmerBrick, 20);
			recipe.AddTile(TileID.Anvils);
			recipe.Register();
		}

	 	public override void OnConsumeMana(Player player, int mana) {
			WorldGen.ShimmerMakeBiome((int)Main.MouseWorld.X / 16, (int)Main.MouseWorld.Y / 16);
		}
	}
}